...
//% weight=10 color=#e7660b icon="\uf185" block="Distance Ranging Sensor"
namespace VL53L0 {
 ...
 * 获取环境计数
 */
//% blockId=VL53L0_getAmbientCount block="get AmbientCount"
//% weight = 50
export function getAmbientCount():number{
    readVL53L0X();
    return ambientCount;
}
 ...
 * 获取信号计数
 */
//% blockId=VL53L0_getSignalCount block="get SignalCount"
//% weight = 40
 ...
 * 获取状态
 */
//% blockId=VL53L0_getStatus block="get Status"
//% weight=30
